...
.hero-overlay {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(90deg, rgba(9, 10, 15, 0.95) 0%, rgba(9, 10, 15, 0.7) 50%, rgba(9, 10, 15, 0.4) 100%);
    z-index: -1;
}
...
@media (max-width: 992px) {
    ...
    .hero-overlay {
        background: linear-gradient(180deg, rgba(9, 10, 15, 0.8) 0%, rgba(9, 10, 15, 0.95) 100%);
    }
